...
import {CLOSE_EDITOR} from '../../constants/action-types'
import {connect} from 'react-redux'
import {addCard} from '../../services/card.service'
import {FETCH_CARDS} from '../../cores/card/constants/actions'
...
function Editor(props) {
    return (
        <>
            <Modal key='editor' visible={props.editing} title='Edit post' onCancel={() => props.closeEditor()}>
                <Form name={'post'} onFinish={values => props.addCard(values)}>
                    <Form.Item name='cardName' rules={[{required: true, message: 'Please add blog title'}]}>
                        <Input placeholder="What's your taught today?" />
                    </Form.Item>
                    <Form.Item name='category' rules={[{required: true, message: 'Please add category'}]}>
                        <Input placeholder="What's the category?" />
                    </Form.Item>
                    <Form.Item name='content' rules={[{required: true, message: 'Please add some content'}]}>
